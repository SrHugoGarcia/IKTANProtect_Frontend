          ...
          <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
            <div className="space-y-5 sm:space-y-4">
              ...
              <p className="text-xl text-gray-500">
                Ya no es suficiente con saber de seguros. Nuestros expertos en
                el sector hidrocarburos cuentan con experiencia comproable en
                los procesos de gestión ante la ASEA, esto crea un factor
